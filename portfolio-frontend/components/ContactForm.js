      ...
      <div className="grid gap-4">
        <div className="relative">
          <input
            ...
            className="w-full p-4 glass rounded-xl text-white placeholder-white/60 focus:ring-2 focus:ring-purple-500 transition-all outline-none"
          />
        </div>
        <div className="relative">
          <input
        ...
        <div className="relative">
          <textarea
            ...
            className="w-full p-4 glass rounded-xl text-white placeholder-white/60 focus:ring-2 focus:ring-purple-500 transition-all outline-none h-40 resize-none"
          ></textarea>
        </div>
