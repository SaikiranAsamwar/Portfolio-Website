...
export default function Nav({ darkMode, toggleDarkMode }) {
  return (
    <header className="glass sticky top-0 z-50 backdrop-blur-xl border-b border-cyan-500/10">
      <div className="container mx-auto px-6 py-5 flex items-center justify-between">
        <Link href="/" className="font-bold text-xl text-white hover:text-cyan-400 transition-colors tracking-tight">
          Saikiran Asamwar
          <span className="text-xs block text-cyan-400 font-normal">AWS DevOps Engineer</span>
        </Link>
